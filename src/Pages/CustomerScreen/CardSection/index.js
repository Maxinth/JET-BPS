...
const CardSection = () => {
  ...
  let approved_data = data1.filter((dat) => dat.status === "approved");
  let pending_data = data1.filter((dat) => dat.status === "pending");
  let pending_data1 = data2.filter((dat) => dat.status === "pending");
            ...
            >
              ...
              <table className={classes.tb}>
                ...
                <tr>
                  ...
                  <td>{data.length > 0 ? +pending_data1.length : null}</td>
                </tr>
              </table>
            </Paper>
          )}
